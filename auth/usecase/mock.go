...
func (m *AuthUsecaseMock) DeleteUser(c context.Context, u *models.User) error {
	args := m.Called(u)

	return args.Error(0)
}

func (m *AuthUsecaseMock) ParseTokenFromString(tokenString string) (*models.User, error) {
