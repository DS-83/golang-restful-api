...
import (
	...
	httpAuth "fotogramm/example-restful-api-server/auth/delivery/http"
	...
	httpPhoto "fotogramm/example-restful-api-server/photogramm/delivery/http"
	"fotogramm/example-restful-api-server/photogramm/repo/local"
	photoMysqldb "fotogramm/example-restful-api-server/photogramm/repo/mysqldb"
	photoUsecase "fotogramm/example-restful-api-server/photogramm/usecase"
	"log"
	"net/http"
	"time"
